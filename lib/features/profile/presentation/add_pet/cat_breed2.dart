...
class CatBreed2 extends StatefulWidget {
  const CatBreed2({super.key});

  @override
  State<CatBreed2> createState() => _CatBreed2State();
}

class _CatBreed2State extends State<CatBreed2> {
          ...
          children: [
            ...
            Center(
              child: MainButton(
                ...
                onTap: () {
                  Navigator.pushNamed(context, Routes.catBreed3);
                },
