class StringManager {
  ...
  static const String petJourney =
      "With you through each part of your pet’s journey.";
  static const String terms =
      "By registering or logging in you have agreed to the terms and conditions";
  ...
  static const String selectYourCatsSecondBreed =
      "Select your cat’s second breed";
  static const String typeAgeAndWeightOfDog =
      "Type the Age and Weight of the Dog";
  static const String typeAgeAndWeightOfCat =
      "Type the Age and Weight of the Cat";
  ...
  static const String selectYourDogsSecondBreed =
      "Select your dog’s second breed";
  ...
  static List<String> sizeListDogKilos = [
    smallDogkilos,
    mediumDogkilos,
    largeDogkilos,
    giantDogkilos
